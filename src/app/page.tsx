      ...
      {teamMemberError ? (
        ...
        <div className="space-y-32 wp-slide-up">
          ...
          <div className="wp-card p-8">
                    ...
                    {teamMember.allocations.map((allocation: Allocation, index: number) => (
                      ...
                      >
                        <div className="flex items-center justify-between">
                          ...
                          {allocation.active && (
                            <span className="px-8 py-3 from-wp-primary to-wp-accent text-white text-base font-bold rounded-full min-w-[100px] text-center">
                              Active
                            </span>
                          )}
                        </div>
              ...
              <div className="wp-card p-8">
                <div className="flex items-center mb-6">
                  <div className="w-12 h-12 from-green-500 to-green-600 rounded-full flex items-center justify-center mr-4">
                    <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      >
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-center">
                          ...
                          <div className="flex justify-between items-center">
                            ...
                            {contract.active && (
                              <span className="px-8 py-3 from-green-500 to-green-600 text-white text-base font-bold rounded-full min-w-[100px] text-center">
                                Active
                              </span>
                            )}
                          </div>
